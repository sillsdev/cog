...
{
	[TestFixture]
	public class WordSurv6WordListsImporterTest
	{
		...
		public void Import()
		{
			...
			const string file3 = "<?xml version=\"1.0\" encoding=\"utf-16\"?>"
							   + "<survey><glosses><gloss id=\"0\"><name>sense1</name><part_of_speech>cat1</part_of_speech></gloss><gloss id=\"0\"><name>sense2</name></gloss></glosses></survey>";
			importer.Import(null, new MemoryStream(Encoding.Unicode.GetBytes(file3), false), project);
			Assert.That(project.Senses.Select(s => s.Gloss), Is.EqualTo(new[] {"sense1", "sense2"}));
			Assert.That(project.Senses.Select(s => s.Category), Is.EqualTo(new[] {"cat1", null}));
			Assert.That(project.Varieties, Is.Empty);
			...
			// senses, varieties, categories, and words
			const string file5 = "<?xml version=\"1.0\" encoding=\"utf-16\"?>"
							   ...
							   + "<glosses>"
							   + "<gloss id=\"0\"><name>sense1</name><part_of_speech>cat1</part_of_speech>"
							   ...
							   + "</gloss>"
							   + "<gloss id=\"1\"><name>sense2</name><part_of_speech>cat2</part_of_speech>"
							   ...
							   + "</gloss>"
							   + "<gloss id=\"2\"><name>sense3</name><part_of_speech>cat3</part_of_speech>"
			...
			const string file9 = "<?xml version=\"1.0\" encoding=\"utf-16\"?>"
							   ...
							   + "<transcriptions><transcription><word_list_id>0</word_list_id><name>word2</name></transcription><transcription><word_list_id>1</word_list_id><name>word5</name></transcription></transcriptions>"
							   + "</gloss>"
							   + "<gloss id=\"2\"><name>sense1</name><part_of_speech>cat3</part_of_speech>"
							   + "<transcriptions><transcription><word_list_id>0</word_list_id><name>word3</name></transcription><transcription><word_list_id>1</word_list_id><name>word6</name></transcription></transcriptions>"
							   + "</gloss>"
							   + "</glosses>"
							   + "</survey>";
